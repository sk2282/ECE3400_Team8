...
hold on;
% get walls at current position
% directions w/out walls go on stack 
% pick one direction (priority to area that has not been visited (1))
% Goes in direction and set current position (0)
% set previous position as visited (.5)
dfs(visited,curr_loc, wall_loc, detected_wall_loc);
